  ...
  if (isMobile) {
    return (
      <footer className="m-footer" id="footer">
        ...
        <div style={{ marginTop: 32, fontSize: 12, color: "#939393", lineHeight: 1.65 }}>
          <p style={{ fontWeight: 600, fontSize: 14, color: "#fff", marginBottom: 8 }}>Get in Touch</p>
          <p>Support@Divintalk.in</p>
          <p style={{ marginTop: 4 }}>+91 8104151935</p>
